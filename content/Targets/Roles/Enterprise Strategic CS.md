...
target_companies:
  ...
  - Oracle
  - SailPoint
aliases: [Strategic CS, Enterprise CS, Key Account Management, Named Accounts]
---
...
| Strength | Evidence |
|----------|----------|
| Executive relationships | CIOs, IT Directors, department heads |
| Escalation management | 13/14 resolved without concessions |
| Account planning | Strategic accounts through full lifecycle |
| Business reviews | QBR/EBR delivery experience |
| Complex stakeholders | Government = complex by nature |

### Gaps to Address
| Gap | Mitigation |
|-----|------------|
| ARR/revenue responsibility | Frame implementations as revenue protection |
| Expansion quota experience | Emphasize renewal positioning and growth identification |
| Enterprise SaaS logos | Tyler serves enterprise government—reframe |
| Fortune 500 experience | Government clients are large, complex organizations |
...
- [[Illinois Vehicle Code]] (too niche)
- Implementation-heavy language (reframe as CS)
...
### Supporting Evidence
5. [[Training & Enablement Program]] — Executive workshops
6. [[Morton Grove Technology Modernization]] — Strategic transformation
...
| [[Microsoft Strategic Account]] | Microsoft | Technology strategist |
| [[SailPoint Sr CSM]] | SailPoint | Identity, enterprise security |
| [[McKinsey Client Success]] | McKinsey | Transformation, consulting |
| [[Amplo Sr CSM]] | Amplo | Strategic B2B |
...
|---------|--------------|-------|
| Microsoft | CSAM program, enterprise focus | Strong brand |
| Salesforce | Enterprise CS leader | Established CS org |
| ServiceNow | Enterprise workflow | Government vertical |

### Tier 2 (Good Fit)
| Company | Why Good Fit | Notes |
|---------|--------------|-------|
| SailPoint | Identity management | Security focus |
| Workday | Enterprise HR/Finance | Large accounts |
| SAP | Enterprise ERP | EAM experience relevant |

### Tier 3 (Stretch)
| Company | Why Good Fit | Notes |
|---------|--------------|-------|
| Oracle | Enterprise software | Large, complex |
| Adobe | Enterprise creative/marketing | Different domain |
...
|-------|------|-----|--------|
| CSM (Enterprise) | $100-130K | $120-150K | RSUs |
| Sr. CSM / CSAM | $120-150K | $150-180K | RSUs |
| Principal CSM | $140-170K | $170-200K | RSUs |
