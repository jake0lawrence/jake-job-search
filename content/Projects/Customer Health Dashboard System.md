...
role: Implementation Consultant / CSM
skills:
  - "[[Power BI]]"
...
> Built Power BI dashboards integrating Dynamics, JIRA, and PSA data to track customer health and flag at-risk accounts 1-2 weeks earlier than previous methods.
...
- Established thresholds that triggered intervention playbooks
- Created executive summary views for leadership visibility
...
**Best theme for this project:** Data-driven decision making and proactive risk management
...
**Situation:**
Customer risk was being identified too late—often after escalation. Data existed across Dynamics, JIRA, and PSA but wasn't consolidated. Leadership lacked portfolio visibility. Consultants were reactive rather than proactive.
...
- Established thresholds that triggered specific intervention playbooks
- Created executive summary for leadership review
- Trained team on interpretation and response protocols
