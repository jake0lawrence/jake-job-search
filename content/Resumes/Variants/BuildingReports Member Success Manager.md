...
**Company:** BuildingReports
**Title:** Member Success Manager (Midwest Region)
...
- [[Public Sector & GovTech]] — Relevant but not emphasized
- [[Municipal Courts]] — Omitted
- Heavy technical language — Field enablement focus
...
4. [[Customer Health Dashboard System]] — At-risk member detection
5. [[Executive Escalation Resolution Program]] — 13/14 protecting relationships
6. [[Morton Grove Technology Modernization]] — Field staff training
...
**Resume filename:** `Jacob_Lawrence_Resume_BuildingReports_MSM.docx`
**Status:** Ready
**Customization notes:**
