...
status: active
company: Intercom
role: Customer Success Manager (Scaled)
...
**Company:** Intercom
**Title:** Customer Success Manager (Scaled Engagement)
...
- Enterprise strategic language — Positioned as scaled
...
5. [[Executive Escalation Resolution Program]] — Voice of Customer
6. [[Status Pack Automation]] — Process automation example
...
**Resume filename:** `Jacob_Lawrence_Resume_Intercom_CSM.docx`
**Status:** Ready
**Customization notes:**
