...
actively_using: true
last_used: 2025-01
aliases: [Microsoft Power BI, Power BI Desktop, BI Dashboards, Business Intelligence]
---
...
Microsoft's business intelligence and data visualization platform. Used to build interactive dashboards, reports, and data models that transform raw data into actionable insights. Core tool for customer health monitoring, implementation tracking, and executive reporting.
...
| Context | Framing |
|---------|---------|
| Technical audience | "Built operational dashboards (Dynamics, JIRA, Power BI) to track implementation health, testing progress, and risk indicators" |
...
- **Result:** Identified at-risk accounts 1-2 weeks earlier; enabled proactive intervention playbooks

## ATS Keywords

Power BI, Microsoft Power BI, Business Intelligence, BI Dashboards, Data Visualization, DAX, Data Analyst, Power BI Desktop, Power BI Service, Microsoft Certified