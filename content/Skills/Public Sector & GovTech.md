...
Deep expertise in serving government clients—municipalities, courts, state agencies—with technology solutions. Includes understanding of government operations, procurement processes, compliance requirements, stakeholder dynamics, and the unique challenges of public sector digital transformation.
...
- Prior government employment: Management Analyst (Morton Grove), Deputy Village Clerk (Itasca)
...
- State agencies
- Court administrators, City Clerks, IT Directors

## Resume Presence

**Appears in:** 9/25 variants (targeted)
...
| Context | Framing |
|---------|---------|
| Technical audience | "Led 100+ implementations for public sector clients including courts, municipalities, and state agencies" |
...
**Target:** Continue building GovTech expertise; explore state-level opportunities
...
- **Result:** On-time go-live; all stakeholder groups satisfied; became reference account

## ATS Keywords

GovTech, Government Technology, Public Sector, Municipal, State and Local Government, Government SaaS, Civic Tech, Public Administration, Government Operations, Government Procurement